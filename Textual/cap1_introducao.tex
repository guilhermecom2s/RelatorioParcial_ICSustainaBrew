...
Nesta seção abordaremos a fundamentação teórica do trabalho, tratando de conceitos de: transformação digital, computação em nuvem, edge computing e outros.
